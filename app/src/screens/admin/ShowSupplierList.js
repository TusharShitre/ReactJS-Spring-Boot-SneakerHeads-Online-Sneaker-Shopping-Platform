            ...
            <tbody>
                ...
                {this.state.suppliers.map(
                        ...
                        <tr key={supplier.id}>
                                ...
                                <td><Link to={"/supplier/showproductsbysupplier/"+supplier.id} className="btn btn4">Check Products</Link></td>
                                <td><Link to={"/addproductfromsupplier/"+supplier.id} className="btn btn4">Check Available Products</Link></td>
                                <td><Link to={"/supplieraddress/"+supplier.id} className="btn btn4">Address</Link></td>
                            </tr>
                    )
                }
            </tbody>  
            <br></br>
            <button className="btn4" onClick={() => this.addSupplier()}>Add Supplier</button>       
        </table>
    </div>
