...
const TermAndConditionScreen = () => {
    return (
        <div>
            ...
            <p>SneakerHeads is the licensed owner of the brand mygreenmart.in 
                and the website mygreenmart.in (”The Site”).SneakerHeads
                 respects your privacy. This Privacy Policy provides succinctly 
                 the manner your data is collected and used by SneakerHeads on 
                 ...
                 use of your data by SneakerHeads in the manner provided in this 
                 Privacy Policy.
            </p>
            <br/>
            <h5>Services overview
</h5>
            <p>As part of the registration process on the Site, SneakerHeads 
            ...
            <p>SneakerHeads grants you a limited sub-license to access and make 
                ...
                written consent of SneakerHeads. This license does not include 
                ...
                express written consent of SneakerHeads. You may not frame or utilize 
                ...
                of SneakerHeads and its affiliates without express written consent. 
                You may not use any meta tags or any other “hidden text” utilizing the 
                Site’s or SneakerHeads’s name or MGM’s name or trademarks without the 
                express written consent of SneakerHeads. Any unauthorized use terminates 
                the permission or license granted by SneakerHeads</p>
            <br/>
        </div>
        </div>
    );
