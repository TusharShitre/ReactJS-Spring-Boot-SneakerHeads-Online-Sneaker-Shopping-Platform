       ...
       <div>
        ...
        {this.state.cart.map(product =>
                <tr key={product.id}>
                    ...
                    <td>{product.qty}</td>
                    <td>
                    <button className="btn4 " onClick={() => this.deleteProduct(product.id, product.qty)}>Delete</button>
                    </td>
                </tr>
                )}
        </tbody>         
        ...
        <button className="btn4" style={{width:'200px'}} onClick={() => this.addAddress()}>Add Address</button><br/><br/>
        <button className="btn4" style={{width:'200px'}} onClick={() => this.placeOrder()}>Place Order</button>
